...
function registerUser() {
    ...
    if (newUserName.value === '' || newPassword.value === '') {
        Toastify({
            text: "¡Tu usuario o contraseña no puede estar vacío!",
            duration: 3000,
            newWindow: false,
            close: true,
            gravity: "bottom",
        ...
        Toastify({
            text: "¡Tu nombre de usuario y contraseña debe ser entre 5 y 20 carácteres!",
            duration: 3000,
            newWindow: false,
            close: true,
            gravity: "bottom",
...
function loginUser() {
    ...
    if ( loggedInUser ) {
        ...
        Toastify({
            text: "Esta cuenta no existe o los datos son incorrectos",
            duration: 3000,
            newWindow: false,
            close: true,
            gravity: "bottom",
